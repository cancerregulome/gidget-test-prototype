...
public class Pipe {
    ...
    public final Artifact_Manifest artifactManifest;

    private Pipe(Map<Artifact_ID, Artifact> mpaid_artifact, Artifact_Manifest artifactManifest) {
     ...
     * @return
     */
    public static Pipe FromDirectoryXattr(File directory, Artifact_Manifest manifest) {
        // TODO implement
     ...
     * @return a Pipe
     */
    public static Pipe FromDirectory(File directory, Artifact_Manifest manifest) {
        Map<Artifact_ID, Artifact> mpaid_artifact = new HashMap<>();
    ...
    private static void FromDirectory_helper(
            Map<Artifact_ID, Artifact> accumulate,
            File file,
    ...
    private static void LoadArtifactsFile(File artifactsFile, Map<Artifact_ID, Artifact> accumulate, Artifact_Manifest manifest) {
        try (CSVParser in = new CSVParser(new FileReader(artifactsFile), ARTIFACTS_FORMAT)) {
            for (CSVRecord record : in) {
                ...
                Artifact_ID aid = manifest.ArtifactIDFromUUID(uuid);
